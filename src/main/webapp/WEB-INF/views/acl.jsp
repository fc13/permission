    ...
    <form id="aclForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            <tr>
                ...
                <td>
                    <select id="aclModuleSelectId" name="aclModelId" data-placeholder="选择权限模块" style="width: 200px;"></select>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    $(function() {
        ...
        function loadAclList(aclModuleId) {
            ...
            var url = "/sys/acl/page.json?aclModelId=" + aclModuleId;
                ...
                if (result.data.total > 0){
                    var rendered = Mustache.render(aclListTemplate, {
                        ...
                        "showAclModuleName": function () {
                            return aclModuleMap[this.aclModelId].name;
                        },
                        "showStatus": function() {
